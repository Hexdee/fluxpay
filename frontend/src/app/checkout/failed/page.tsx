  ...
  return (
    <main className='checkout-wrap'>
      <section className='state-card'>
        <div className='state-top'>
          <Brand />
          <span className='status warn'>Payment failed</span>
        </div>
        <div className='state-body'>
          <h1>Your payment could not be completed.</h1>
          <p className='cell-muted'>
            The merchant has been notified. You can retry the payment or contact
          ...
          <div className='state-rows'>
            <div className='state-row'>
              <span>Order</span>
              <strong>
                <TruncateCopy value={orderId ?? paymentId} label='Copy reference' />
              </strong>
            </div>
            <div className='state-row'>
              <span>Merchant</span>
